...
import { AlertTriangle, Activity, Target, Dumbbell, Trophy, Medal } from 'lucide-react';
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-slate-800 border border-slate-700 rounded-2xl p-6 shadow-xl col-span-1 md:col-span-2 relative overflow-hidden relative">
                    ...
                    {latestBiometrics ? (
                        ...
                        <p className="text-slate-400">Información no disponible.</p>
                    )}
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-slate-800 border border-slate-700 rounded-2xl p-6 shadow-xl h-fit">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="font-semibold text-white">Mis Récords Personales (PRs)</h3>
                    </div>
